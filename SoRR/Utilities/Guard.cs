...
namespace SoRR
{
    ...
    public static class Guard
    {
        ...
        [DoesNotReturn]
        private static void ThrowNull(string? paramName = null)
        ...
        {
            if (EqualityComparer<T>.Default.Equals(value, other)) ThrowEqual(value, other, paramName);
        }
        /// <summary>
        ...
        public static void ThrowIfNotEqual<T>(T value, T other, [CallerArgumentExpression(nameof(value))] string? paramName = null)
            where T : IEquatable<T>
        {
            if (!EqualityComparer<T>.Default.Equals(value, other)) ThrowNotEqual(value, other, paramName);
        }
        /// <summary>
        ...
        [DoesNotReturn]
        private static void ThrowNotInRange<T>(T value, T min, T max, string? paramName)
